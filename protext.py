...
def get_obfuscated_text(text):
    obfuscated_text_html = re.findall("<h1 id='obfuscated'>(.*)</h1>", text)[0]
    return html.unescape(obfuscated_text_html)

with requests.session() as s:
    r1 = s.get("http://protext.hackerrank.com/?text=abcdefghijklmnopqrstuvwxyz1234567890%20ABCDEFGHIJKLMNOPQRSTUVWXYZ")
    r2 = s.get("http://protext.hackerrank.com/")
